  ...
  await Podcast.insertMany([
    {
      ...
      category: 'Sleep',
      tags: ['new', 'sleep'],
      description: 'A calming bedtime story to help you drift off into a deep, restful sleep.',
    },
    {
      ...
      isDailyPick: false,
      category: 'Mindset',
      tags: ['popular', 'mindset'],
      description: 'Practical mindset techniques to help you release anxiety and move forward with confidence.',
    },
    {
      ...
      category: 'Sleep',
      tags: ['trending', 'sleep'],
      description: 'An immersive audio journey through strange and soothing dreamscapes.',
    },
    {
      ...
      category: 'Focus',
      tags: ['now', 'focus'],
      description: 'Neuroscience-backed exercises to sharpen your focus and build lasting habits.',
    },
    {
      ...
      isDailyPick: false,
      category: 'Sleep',
      tags: ['new', 'popular', 'sleep'],
      description: 'A gentle guided meditation set to soft instrumental melodies for deep relaxation.',
    },
  ]);
